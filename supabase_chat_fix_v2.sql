-- Fix chat system policies and functions - Version 2
...
-- Drop and recreate the mark_conversation_as_read function with proper parameter naming
DROP FUNCTION IF EXISTS mark_conversation_as_read(UUID, TEXT);
